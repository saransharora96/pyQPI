...
class AuxiliaryDataGeneration:
    ...
    def generate_and_save_auxiliary_data(self):
        ...
        tomogram_binary_mask_path = self.save_image(tomogram_binary_mask, self.directories['tomogram_binary_mask'], f"{base_name}_tomogram_binary_mask")
        ...
        tomogram_segmented_path = self.save_image(tomogram_segmented, self.directories['tomogram_segmented'], f"{base_name}_tomogram_segmented")
        ...
        mip_path = self.save_image(mip, self.directories['mip'], f"{base_name}_mip")
        ...
        segmented_mip_path = self.save_image(segmented_mip, self.directories['mip_segmented'], f"{base_name}_mip_segmented")
